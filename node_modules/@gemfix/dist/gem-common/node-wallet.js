...
//@ts-ignore
const spl_token_018_1 = require("@solana/spl-token-018");
class NodeWallet extends account_utils_1.AccountUtils {
    constructor(conn, wallet) {
        super(conn);
        this.wallet = wallet;
    }
    topUpWallet(lamports) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.conn.confirmTransaction(yield this.conn.requestAirdrop(this.wallet.publicKey, lamports));
        });
    }
    ...
    createMint(decimals, authority = this.wallet.payer) {
        return __awaiter(this, void 0, void 0, function* () {
            return spl_token_018_1.Token.createMint(this.conn, authority, authority.publicKey, authority.publicKey, decimals, spl_token_018_1.TOKEN_PROGRAM_ID);
        });
    }
    createNativeMint() {
        return __awaiter(this, void 0, void 0, function* () {
            return new spl_token_018_1.Token(this.conn, spl_token_018_1.NATIVE_MINT, spl_token_018_1.TOKEN_PROGRAM_ID, this.wallet.payer);
        });
    }
    createAndFundATA(token, owner, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            if (token.publicKey == spl_token_018_1.NATIVE_MINT) {
                const account = yield spl_token_018_1.Token.createWrappedNativeAccount(this.conn, spl_token_018_1.TOKEN_PROGRAM_ID, owner, this.wallet.payer, amount.toNumber());
                return account;
            }
            else {
