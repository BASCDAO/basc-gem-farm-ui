...
class AccountUtils {
    ...
    deserializeToken(mint) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new spl_token_018_1.Token(this.conn, mint, spl_token_018_1.TOKEN_PROGRAM_ID, throwawayKeypair);
        });
    }
    ...
    findATA(mint, owner) {
        return __awaiter(this, void 0, void 0, function* () {
            return spl_token_018_1.Token.getAssociatedTokenAddress(spl_token_018_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_018_1.TOKEN_PROGRAM_ID, mint, owner, true);
        });
    }
}
